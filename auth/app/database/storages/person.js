...
class PersonStorage {
   ...
   */
  async create (name, pass, email, college_id, claims, aud) {
    return this.$model.create({ name: name, pass: pass, email: email, college_id: college_id, claims: claims, aud: aud })
